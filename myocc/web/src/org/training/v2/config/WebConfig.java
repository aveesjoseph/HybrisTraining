...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "myocc.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "myocc.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "myocc.oauth2.tokenUrl";

	private static final String DESC = "myocc.v2.description";
	private static final String TITLE = "myocc.v2.title";
	private static final String VERSION = "myocc.v2.version";
	private static final String LICENSE = "myocc.v2.license";
	private static final String LICENSE_URL = "myocc.v2.license.url";
