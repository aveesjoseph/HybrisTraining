...
public class BaseSiteMatchingFilter extends AbstractUrlMatchingFilter {
	...
	protected void doFilterInternal(
		...
		if (baseSiteID != null
				&& !baseSiteID.equalsIgnoreCase("getAllDealers")
				&& !baseSiteID.equalsIgnoreCase("getAllDrivers")) {
			...
			if (requestedBaseSite != null) {
				...
				final InvalidResourceException ex =
						new InvalidResourceException(YSanitizer.sanitize(baseSiteID));
